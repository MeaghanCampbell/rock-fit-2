        ...
        <div class="text-center m-6 text-white space-y-8 w-screen max-w-md">
            ...
            <div>
                <form class="flex flex-col text-lg">
                    <input class="w-full rounded-lg bg-black green-border px-2 py-1 focus:outline-none" placeholder="email" type="email">
                    <input class="w-full rounded-lg bg-black green-border px-2 py-1 focus:outline-none mt-3" placeholder="username" type="text">
                    <input class="w-full rounded-lg bg-black green-border px-2 py-1 focus:outline-none mt-3" placeholder="password" type="password">
                    <button class="btn mt-8 transition rounded-lg text-black p-2 font-semibold" type="button">Sign Up</button>
                </form>
            </div>
